                    ...
                    <table class="table table-striped table-hover table-bordered" id="list-product">
                        <thead>
                            ...
                            <tr role="row" class="filter">
                                ...
                                <td></td>
                                <td>
                                    <input type="text" class="form-control form-filter input-sm" placeholder="Search by Name" name="search[name]">
                                </td>
                                <td>
                                    <select data-toggle="tooltip" title="Search Category" class="form-control form-filter input-sm" name="search[category][]" multiple placeholder="Search by Category">
...
var columnDefs = [
        ...
        },
        {
            ...
            "sortable"  : false,
            "data" : function(row, type, val, meta) {
                return '<img style="max-height: 110px;" src="'+ row[3] +'" />';
            }
        },
        {
            "targets": 4,
            ...
            "className" : "text-center",
            "data" : function(row, type, val, meta) {
                return '<i class="fa fa-book" data-placement="right" data-toggle="tooltip" title="'+ row[4] +'"></i>';
            }
        },
        {
            "targets": 5,
            ...
            "data" : function(row, type, val, meta) {
                ...
                return '<a href="javascript:void(0)" class="xeditable-select" data-escape="true" data-name="active" data-type="select" data-value="'+row[5]+'" data-pk="'+row[1]+'" data-url="{{ URL.'/admin/products/update-product' }}" data-title="Active">'+html+'</a>';
            }
        },
    ];
listRecord({
