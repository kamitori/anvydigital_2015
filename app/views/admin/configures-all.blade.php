            ...
            <div class="tab-pane active" id="main">
                ...
                <div class="form-body">
                    ...
                    <div class="form-group col-md-12">
                        ...
                        <div class="col-md-10">
                            <input type="text" name="title_site" class="form-control maxlength-handler" maxlength="100"  value="{{ $configure['title_site'] or '' }}"><span class="help-block">
                                        max 100 chars </span>
                        </div>
                    </div>
                    <div class="form-group col-md-12">
                        <label class="control-label col-md-2">Key Word</label>
                        <div class="col-md-10">
                            <input type="text" name="key_word" class="form-control maxlength-handler" maxlength="250"  value="{{ $configure['key_word'] or '' }}"><span class="help-block">
                                        max 250 chars </span>
                        </div>
                    </div>
                    <div class="form-group col-md-12">
