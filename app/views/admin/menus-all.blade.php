							...
							<div class="portlet-body form">
								<form id="update-menu" action="{{ URL.'/admin/menus/update-menu' }}"  method="POST" class="form-horizontal" role="form" id="menu-info">
									...
									<div class="form-body">
										...
										<div class="form-group" id="column-div">
											<label class="col-md-3 control-label">Column no</label>
											<div class="col-md-9">
												<div id="column_spinner">
													<div class="input-group input-small">
														<input type="text" class="spinner-input form-control" minlength="1" value="1" readonly id="column_no" name="column_no">
...
$('#column_spinner').spinner({value:1, min: 1, max: 4});
...
function menuInit(arrType)
{
	...
	for(var i in arrType) {
		var t = arrType[i];
		if( $.inArray(t, ['header', 'footer', 'product']) != -1 ) {
			t = "frontend";
		}
...
function editMenu(id)
{
	...
	for(i in info){
		...
		if( $("#"+i).is(":checkbox") ) {
			...
			$("#column_spinner").spinner("value", info[i]);
			$("#"+i).val(info[i]);
		} else {
