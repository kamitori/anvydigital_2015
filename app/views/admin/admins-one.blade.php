                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        @foreach (['','General question','Quote request','Order status','Technical problem','File setup questions','Product questions','Shipping questions','Mailing inquiries','Feedback review','Account billing','Business development','Other'] as $subject)
                                            <option value="{{ $subject }}" {{ isset($admin['subject']) && $admin['subject'] == $subject ? 'selected' : '' }}>{{ $subject }}</option>
                                        @endforeach
                                        </select>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="fileinput fileinput-new" data-provides="fileinput">
                                            <div class="fileinput-new thumbnail" style="width: 200px; height: 150px;">
                                                @if( isset($admin['images']['path']) && !empty($admin['images']['path']) )
                                                <img data-origin-src="{{ URL::asset($admin['images']['path']) }}" src="{{ URL::asset($admin['images']['path']) }}" alt=""/>
                                                @else
...
@stop
@extends('admin.layout.image-browser', ['controller' => 'admins', 'holder' => '#tab_person', 'itemWidth' => 125])