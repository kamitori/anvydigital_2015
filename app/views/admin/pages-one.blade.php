                ...
                <div class="tab-content no-space">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-10">
                                    <select class="form-control" name="type">
                                        ...
                                        <option @if( isset($page['type']) && $page['type'] == $type ) selected @endif value="{{ $type }}">{{ $type }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                    ...
                    <div class="tab-pane" id="content">
                        ...
                        <div id="ckeditor-container">
                            <textarea class="form-control" id="page-content" name="content">{{ $page['content'] or '' }}</textarea>
                        </div>
...
var styles = ['{{ URL::asset( 'assets/content-builder/css/content.css' ) }}','{{ URL::asset( 'assets/css/bootstrap/bootstrap.min.css' ) }}', '{{ URL::asset( 'assets/css/main.css' ) }}', '{{ URL::asset( 'assets/css/fonts.css' ) }}'];
