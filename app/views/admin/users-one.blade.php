                ...
                <div class="tab-content no-space">
                    ...
                    <div class="tab-pane active" id="tab_account">
                        <div class="form-body">
                            ...
                            <div class="row">
                                <div class="form-group col-md-6">
                                    <label class="control-label col-md-4">Subscribed</label>
                                    <div class="col-md-8">
                                        <input type="checkbox" class="form-control" name="subscribe" {{ isset($user['subscribe']) && $user['subscribe']=='1' ? 'checked' : '' }}>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="form-group col-md-6">
                                    <label class="control-label col-md-4">User VIP</label>
                                    <div class="col-md-8">
                                        <input type="checkbox" class="form-control" name="vip" {{ isset($user['vip']) && $user['vip']=='1' ? 'checked' : '' }}>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="fileinput fileinput-new" data-provides="fileinput">
                                            <div class="fileinput-new thumbnail" style="width: 200px; height: 150px;">
                                                @if( isset($user['images']['path']) && !empty($user['images']['path']) )
                                                <img data-origin-src="{{ URL::asset($user['images']['path']) }}" src="{{ URL::asset($user['images']['path']) }}" alt=""/>
                                                @else
                                ...
                                <div class="col-md-8">
                                    ...
                                    <div class="row form-group ">
                                        ...
                                        <div class="col-md-8">
                                            <input type="text" name="company_name" class="form-control" placeholder="" value="{{ $user['company_name'] or '' }}">
                                        </div>
                                    </div>
                                    <div class="row form-group ">
                                        <label class="control-label col-md-4">Phone</label>
                                        <div class="col-md-8">
                                            <input type="text" name="phone" class="form-control" placeholder="" value="{{ $user['phone'] or '' }}">
                                        </div>
                                    </div>
                                </div>
                            </div>
...
{
    $("#choose_image", "#tab_person").remove();
    $(".thumbnail > img", "#tab_person").attr("src", $(".thumbnail > img", "#tab_person").attr("data-origin-src"));
}

function chooseImage(object)
{
    var parent = $("#tab_person");
...
@stop
@extends('admin.layout.image-browser', ['controller' => 'users', 'holder' => '#tab_person', 'itemWidth' => 125])