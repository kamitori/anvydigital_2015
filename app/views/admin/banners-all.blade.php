                    ...
                    <table class="table table-striped table-hover table-bordered" id="list-banner">
                        <thead>
                            ...
                            <tr role="row" class="filter">
                                ...
                                <td>
                                    <input type="text" class="form-control form-filter input-sm" name="search[link]">
                                </td>
                                <td>
                                </td>
                                <td>
...
var columnDefs = [
        ...
        },
        {
            ...
            "name"  : "description",
            "data" : function(row, type, val, meta) {
                return '<a href="javascript:void(0)" class="xeditable-input" data-escape="true" data-name="description" data-type="textarea" data-pk="'+row[1]+'" data-url="{{ URL.'/admin/banners/update-banner' }}" data-title="Name">'+row[3]+'</a>';
            }
        },
        {
            "targets": 4,
            "name"  : "link",
            "data" : function(row, type, val, meta) {
                return '<a href="javascript:void(0)" class="xeditable-input" data-escape="true" data-name="link" data-type="textarea" data-pk="'+row[1]+'" data-url="{{ URL.'/admin/banners/update-banner' }}" data-title="Link">'+row[4]+'</a>';
            }
        },
        {
            "targets": 5,
        ...
        },
        {
            ...
            "data" : function(row, type, val, meta) {
                ...
                return '<a href="javascript:void(0)" class="xeditable-select" data-escape="true" data-name="active" data-type="select" data-value="'+row[7]+'" data-pk="'+row[1]+'" data-url="{{ URL.'/admin/banners/update-banner' }}" data-title="Active">'+ html +'</a>';
            }
        },
    ];
listRecord({
...
@extends('admin.layout.image-browser',['controller' => 'banners', 'holder' => '#image-div', 'itemWidth' => 250, 'modalWidth' => 90])