...
<head>
	...
	*/
    ...
    @media only screen and (max-width: 480px) {
        .footerContainer a[class=utilityLink] {
            display: block !important;
        }
    }
    </style>
                                                                                        ...
                                                                                        <tbody>
                                                                                            <tr>
                                                                                                <td class="mcnImageContent" valign="top" style="padding-right: 0px; padding-left: 0px; padding-top: 0; padding-bottom: 0;">
                                                                                                    <img align="left" alt="" src="https://gallery.mailchimp.com/40b4175ecf0af4650fd3becba/images/60874a89-c086-4473-af81-c3ba419ad878.jpg" width="600" style="max-width:900px; padding-bottom: 0; display: inline !important; vertical-align: bottom;" class="mcnImage">
                                                                                                </td>
                                                                                            </tr>
                                                                                        </tbody>
                                                                                    </table>
                                                                                        ...
                                                                                        <tbody>
                                                                                            <tr>
                                                                                                <td valign="top" class="mcnTextContent" style="padding-top:9px; padding-right: 18px; padding-bottom: 9px; padding-left: 18px;">
                                                                                                    <h1><span style="color:#cc0033"><span style="font-family:arial,helvetica neue,helvetica,sans-serif">Welcome to Anvy Digital!&nbsp;</span></span></h1>
                                                                                                </td>
                                                                                            </tr>
                                                                                        </tbody>
                                                                                    </table>
                                                                                ...
                                                                                <td valign="top" class="mcnTextBlockInner">
                                                                                    <table align="left" border="0" cellpadding="0" cellspacing="0" width="600" class="mcnTextContentContainer">
                                                                                        <tbody>
                                                                                            <tr>
                                                                                                <td valign="top" class="mcnTextContent" style="padding-top:9px; padding-right: 18px; padding-bottom: 9px; padding-left: 18px;">
                                                                                                    <span style="font-family:arial,helvetica neue,helvetica,sans-serif"><span style="color:#696969">Thanks for registering with us. We're so glad you did and you will be too! Now you have acess to exclusive pricing and deals. Get your quotes online with our new online product system. Sign in here to check it all out.&nbsp;<br>
<br>
You can edit your profile and subscription settings in <a href="{{ URL.'#login' }}" target="_blank">Your Account.</a>&nbsp;</span></span>
                                                                                                </td>
                                                                                            </tr>
                                                                                        </tbody>
                                                                                    </table>
                                                                        ...
                                                                        <tbody class="mcnDividerBlockOuter">
                                                                            <tr>
                                                                                <td class="mcnDividerBlockInner" style="min-width:100%; padding:18px;">
                                                                                    <table class="mcnDividerContent" border="0" cellpadding="0" cellspacing="0" width="100%" style="min-width: 100%;border-top-width: 1px;border-top-style: solid;border-top-color: #999999;">
                                                                                        <tbody>
                                                                                            <tr>
                                                                                                <td>
                                                                                                    <span></span>
                                                                                ...
                                                                                <td valign="top" class="mcnTextBlockInner">
                                                                                    <table align="left" border="0" cellpadding="0" cellspacing="0" width="600" class="mcnTextContentContainer">
                                                                                        <tbody>
                                                                                            <tr>
                                                                                                <td valign="top" class="mcnTextContent" style="padding-top:9px; padding-right: 18px; padding-bottom: 9px; padding-left: 18px;">
                                                                                                    You are receiving this email because you registered for an account at AnvyDigital.com. If you'd like to unsubscribe from receiving any further emails please click <a href="{{ URL.'/unsubscribe/'.$token }}" target="_blank">here</a>.
                                                                                                    <br>
                                                                                                    <br> ©2015 AnvyDigital #103 3016-10 Ave NE Calgary, Alberta T2A 6A3
                                                                                                </td>
                                                                                            </tr>
                                                                                        </tbody>
                                                                                    </table>
