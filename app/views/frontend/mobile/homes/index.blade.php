<div class="row banner" style="height: 35vw;">
	@include('frontend.mobile.layout.banner')
</div>

<!-- end Product Service -->
<div class="row home-title graybg">
	<h2>{{ isset($home['home']['header_title']) ? nl2br($home['home']['header_title']) : '' }}</h2>
...
<!-- end Hot product -->
<div class="row home-title graybg">
	<h2>{{ isset($home['home']['main_title']) ? nl2br($home['home']['main_title']) : '' }}</h2>
...
<!-- tileAboutUs  changed from 4 to 1 -->
	...
	<div class="text-left home_info_about">
		<h2>The Company</h2>
		<p>Anvy Digital Imaging Inc. is a large format printing company, but not just any printing company. Anvy Digital is a digital printer, which means we do it faster. With state of the art equipement and dedicated employees, we produce high quality prints that will exceed your standards! Send us your print ready files digitally and we can have your product ready in as little as three days!</p><p> We deliver printed materials that can motivate, educate, or inspire your prospects to become customers.</p>
		</div>
	</div>
</div><!--end row-->
