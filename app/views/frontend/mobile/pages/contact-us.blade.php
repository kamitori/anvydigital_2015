...
<form id="contact-form" action="javascript:void(0)">
    <div style="float: left; margin-top: 20px; margin-bottom: 20px; background-color: #EEEEEE; font-size: 14px; padding-top:10px" id="left-div" class="col-xs-12 left-margin">
        <div class="col-xs-6" id="left-div-pane">
    ...
    <div class="col-xs-12" style="margin-top: 10px; margin-bottom: 10px;" id="right-div">
        <h1>Contact us</h1>
        <br />
    ...
    <div style="margin-top: 10px; margin-bottom: 20px; font-size: 14px;" id="right-div" class="col-xs-12">
        <div id="right-div-pane">
            <div>
                ...
                <div class="row">
                    <textarea class="form-control" cols="10" id="message" name="message" rows="2" tabindex="5" style="height:135px; border-color: #666; resize: none;"></textarea>
                </div>
                <br />
                @if ( 1 == 2 )
                ...
                <div class="row col-xs-12" style="padding-left: 0 !important;">
                ...
                <br />
                <div class="row">
                    <input class="inputButton" type="submit" tabindex="7" value="Submit" id="continueButton" />
                </div>
            </div>
        </div>
    </div>
