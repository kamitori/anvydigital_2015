...
<div class="col-md-10 col-md-offset-1 alignfix">
    <div id="anvyblog" class="blog-container col-md-8">
    </div>
...
$("#blogsidebar").sticky({topSpacing:0, wrapperClassName: 'col-md-3'})
        ...
        for (var i=0; i<theFeeds.length; i++) {
            ...
            if (needFilter === false) {
                if (i <= DEFAULT_ENTRIES) {
                    addEntryToBlogList(entryDate, categories, title, link , content);
                }
            } else {
...
function addEntryToBlogList(entryDate, categories, title, link , content) {
    ...
    rssOutput += '<div class="blog-post"><a target="_blank" href="'+link+'" class="blog-title" id="'+ title +'">' + title + '</a>' + '<p class="blog-date">' + readableDate + '</p>';
