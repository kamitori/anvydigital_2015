...
<div class="row graybg">
    <div class="col-md-9 alignfixall">
        <div class="productBanner" style="background-image: url({{ isset($product['cover']['image'])?$product['cover']['image']:"" }}); background-size: cover; background-position: 50% 50%; background-repeat: no-repeat;">
            <img src="{{ isset($product['cover']['image'])?$product['cover']['image']:"" }}" style="display:none;">
        </div>
    </div>
    <div class="col-md-3 alignfix ordernow">
        <div class="orderbox">
...
<div class="row tab-content">
	<div class="col-md-10 col-md-offset-1 alignfix tab-pane active" id="overview">
		...
		<div class="row" style="margin-left:0;">
			...
			<div class="col-md-9">
				<div class="tab_container">
                    ...
                    <div class="item-pinterest col-md-4 col-xs-6">
                        <a data-pin-do="embedBoard" href="{{ $product['pinterest'] }}" data-pin-scale-width="101" data-pin-scale-height="290" data-pin-board-width="400"></a>
                    </div>
                    @endif
    ...
    @if( !empty($product['specification']) )
    <div class="col-md-10 col-md-offset-1 alignfix tab-pane" id="specification">
        {{ $product['specification'] }}
    </div>
    @endif
    @if( !empty($product['technical']) )
    <div class="col-md-10 col-md-offset-1 alignfix tab-pane" id="technical">
        {{ $product['technical'] }}
    </div>
    @endif
	@foreach($product['tabs'] as $tab)
        <!-- Quick design -->
        @if($tab['tab']['id']==9)
        <div class="col-md-10 col-md-offset-1 alignfix tab-pane" id="tab-{{ $tab['tab']['name_id'] }}">
            <div class="header_product_cont">
        ...
        <div class="col-md-10 col-md-offset-1 alignfix tab-pane" id="tab-{{ $tab['tab']['name_id'] }}">
    		...
    		<div class="six-image-div">
    			...
    			<div class="imagethumbnailwithdesc fadeout col-md-2 col-xs-6">
    ...
    <div class="{{ is_object($user)?'col-md-12 bg_gray':'col-md-10 col-md-offset-1 alignfix'}} tab-pane" id="pricing">
        @if( is_object($user) )
		...
		<div class="col-md-5 bg_gray alignfix" id="product-infomation">
        ...
        <div class="header_product_cont">
            ...
            <div class="price-login-box">
                <text style="padding-right:10px;">Pricing - please login or register to view</text>
