...
var QuickSidebar = function () {
    ...
    var handleQuickSidebarAlerts = function (callBack) {
    ...
    var handleQuickSidebarSettings = function (callBack) {
        if( typeof callBack == 'function' ) {
            callBack();
        }
        var wrapper = $('.page-quick-sidebar-wrapper');
    ...
    return {
        ...
        init: function (options) {
            ...
            handleQuickSidebarChat(options.chat); // handles quick sidebar's chats
            handleQuickSidebarAlerts(options.alert); // handles quick sidebar's alerts
